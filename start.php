		...
		<div class="container">
			<section class="content-inner margin-top-no">
					...
					<div class="row">
						<div class="col-lg-4 col-sm-6">
							<div class="card">
								<div class="card-main">
									<div class="card-inner">
										...
										<p>这里有一点需要注明，因为是在线抓取网页数据并分析，暂未加入数据库，所以速度未知。</p>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner">
										<p class="card-heading">Info Download(将来)</p>
							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner">
										...
										<p>百度协助搜索: 输出搜索结果2&1页所有匹配项(将来用户可自定义)。</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="ui-card-wrap">
					...
					<div class="col-lg-4 col-sm-6"><div class="card"><div class="card-main"><div class="card-inner"><p class="card-heading">1.</p>
										<p>为提高搜索目中率，请尽量输入最精准的番剧名称。</p>
					</div></div></div></div>
					<div class="col-lg-4 col-sm-6"><div class="card"><div class="card-main"><div class="card-inner"><p class="card-heading">2.</p>
										<p>因使用的不是自已的数据库而是网站搜索功能及搜索引擎，所以结果有时会出现偏差或错误。因为匹配代码缘故，可能会引起样式漂移或者输出错误。</p>
					</div></div></div></div>
					<div class="col-lg-4 col-sm-6"><div class="card"><div class="card-main"><div class="card-inner"><p class="card-heading">3.</p>
										<p>若您发现搜索结果短期内不定，可能是因为服务器速度导致。</p>
					</div></div></div></div>
					</div>
				</div>
			</section>

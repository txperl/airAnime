...
<div class="mdui-container main-card mdui-typo">
  ...
  <div class="mdui-card-header">
    <div class="mdui-card-header-title">文档</div>
    <div class="mdui-card-header-subtitle">#airAnime v2 的一些使用说明</div>
  </div>
  
  <div class="mdui-card-content">
    <p>airAnime 是一款聚合<span style="color:#FD5B78;">「番剧&动漫类搜索」</span>程序，借助于各网站的数据及各网站的搜索功能进行综合搜索，以减少寻找在线番剧的时间。</p>
    <p>使用很简单，即先选择自己要搜索的内容类型(Anime, Comic, Noval, PicSearch)，然后搜索相应关键词（动漫名称或图片链接）即可。</p>
    <p>需要注意的是，airAnime 只提供搜索结果，并不提供在线观看功能。</p>
  </div>
